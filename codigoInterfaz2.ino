...
char buttonlabels[15][5] = {"Llam", "Bor", "Fin", "1", "2", "3", "4", "5", "6", "7", "8", "9", "*", "0", "#" };
...
void loop(void) {
  ...
  // Escala para la calibracion de la pantalla
  if (p.z != -1) {
...
void test(){
  if(fona.callerIdNotification(true,FONA_RI_INTERRUPT)){
    tft.println(F("Id activada"));
  }
  else{
    tft.println(F("Id del llamante desactivada"));
  }
  }
  */
